...
brew install less
brew install buku # command-line bookmark manager
brew install googler # command-line google search 
...
pip3 install --user pylint --no-warn-script-location
pip3 install --user flake8 --no-warn-script-location


#############################################
### Application Settings
#############################################
# buku -i ~/Desktop/bookmarks_3_10_21.html
